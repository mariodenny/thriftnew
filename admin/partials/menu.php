    ...
    <div class="menu_list">
      <style>
        ...
        .dropdown_menu_list a {
          margin-left: 10;
          /* Remove extra margin for submenu links */
        }

        .dropdown_menu_list .menu_list_isi,
        .dropdown_menu_list .menu_list_isi_active {
          padding-left: 0;
          /* Remove inherited padding from parent */
        }
      ...
      <?php
      // Ensure BASE_URL and $page_admin are defined before including this partial
...
HTML;
      ...
      <div class="dropdown_menu_list" id="userDropdown">
        ...
        foreach ($user_roles as $user) {
          ...
          $full_url = BASE_URL . "admin/users?role={$user['role']}";
          echo <<<HTML
      <a href="{$full_url}">
        <div class="{$active_class}">
          <div class="box_icon_menu_list_isi">
...
HTML;
      ...
      foreach ($menu_items_bottom as $item) {
        if ($item['page'] === 'pengaturan' && !$added_line_before_settings) {
          echo '<div class="line_menu_list"></div>';
