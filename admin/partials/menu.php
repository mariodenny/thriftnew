...
HTML;
      ...
      <div class="menu_list_isi_dropdown" onclick="toggleDropdown('userDropdown')">
        <div class="box_icon_menu_list_isi"><i class="fas fa-users-cog"></i></div>
        <p>
          Akun User
        ...
        foreach ($user_roles as $user) {
          ...
          echo <<<HTML
            <a href="{$url}admin/users?role={$user['role']}">
              <div class="{$active_class}">
                <div class="box_icon_menu_list_isi"><i class="fas {$user['icon']}"></i></div>
                <p>{$user['label']}</p>
              </div>
            </a>
HTML;
      ...
      <a href="<?= $url; ?>system/admin/logout.php">
        <div class="menu_list_isi">
          <div class="box_icon_menu_list_isi"><i class="fas fa-sign-out-alt"></i></div>
          <p>Log Out</p>
        </div>
      </a>
...
</div> <!-- end box_menu_admin -->

<!-- Script: Toggle Dropdown dan Menu -->
<script>
